...
<div class="content-page">
	<div class="content">
			...
			<div class="row">
				<div class="col-xl-12">
					<div class="breadcrumb-holder">
						<h1 class="main-title float-left">Chỉnh sửa thông tin</h1>
		...
		<div class="container-fluid backgroud_white">
			<form name="create-question" action="<?php echo route('post.admin.edit.news',['id'=>$post_id]); ?>" method="POST" enctype="multipart/form-data">
					...
					<div class="col-lg-4 col-md-4 col-xs-12 col-sm-12">
						<div class="form-group">
							...
							<select class="form-control" name="cate_id">
								<?php echo menuMulti(App\Models\Category::getList(3),3,"--",old('cate_id', isset($data) ? $data['categorieID'] : 0 )); ?>
							</select>
						</div>
						<div class="form-group">
