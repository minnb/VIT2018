...
<div class="content-page">
	<div class="content">
			...
			<div class="row">
				<div class="col-xl-12">
					<div class="breadcrumb-holder">
						<h1 class="main-title float-left">Chính sách bảo mật</h1>
		...
		<div class="container-fluid backgroud_white">
			<form name="create-question" action="<?php echo route('post.admin.list.baomat'); ?>" method="POST" enctype="multipart/form-data">
