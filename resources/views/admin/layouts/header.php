...
<div id="main">
	...
	<div class="headerbar">
        ...
        <div class="headerbar-left">
			<a href="<?php echo route('dashboard') ?>" class="logo"><img alt="Logo" src="<?php echo asset('public/assets/images/logo.png') ?>" /> <span>Admin</span></a>
        </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-lg">
                                ...
                                <a href="#" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-faded">
                                        <img src="<?php echo asset('public/assets/images/avatars/avatar2.png') ?>" alt="img" class="rounded-circle img-fluid">
                                    </div>
                                ...
                                <a href="#" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-faded">
                                        <img src="<?php echo asset('public/assets/images/avatars/avatar3.png') ?>" alt="img" class="rounded-circle img-fluid">
                                    </div>
                                    <p class="notify-details">
                                        <b>Michael Cox</b>
                                ...
                                <a href="#" class="dropdown-item notify-item">
                                    <div class="notify-icon bg-faded">
                                        <img src="<?php echo asset('public/assets/images/avatars/avatar4.png') ?>" alt="img" class="rounded-circle img-fluid">
                                    </div>
                                    <p class="notify-details">
