    ...
    <div class="row">
      <div class="col-xs-12">
        <ul>
          ...
          <li class=""> <a title="Sản phẩm sản xuất tại Vitduct" href="#">Kết quả tìm kiếm</a><span>&raquo;</span></li>
          <li class=""> <a title="Sản phẩm sản xuất tại Vitduct" href="#"><?php echo $keyword; ?></a></li>
        </ul>
      </div>
    </div>
  </div>
